 ...
 * =============
 * Required Files:
 *   Semiexpression.cs Tokenizer.cs
 * 
 * Compiler Command:
 *   csc /target:library /define:TEST_SEMI Semiexpression.cs Tokenizer.cs
 * 
 * Maintenance History
 * ===================
 * ver 2.2 : 14 Aug 14
...
namespace SemiEx
{
    public class CSemiExp
    {
      ...
      { 
        ...
        /*<-------This will find the next position of given token starting from the location of that token----->*/
        public int findNext(int position,string str)
        {
            int pos = position + 1;
    ...
    static void Main(string[] args)
    {
      ...
      string testFile = "../../Semiexpresion.cs";
